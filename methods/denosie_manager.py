    ...
    def train(self, args):
        ...
        for i in range(args.total_round):
            ...
            for steps, (training_data, valid_data, test_data, current_relations, historic_test_data, seen_relations) in enumerate(sampler):
                ...
                clean_data_dict, clean_data, new_training_data = self.data_separation(args, encoder, train_data_for_initial)
                self.moment.init_moment(args, encoder, clean_data, is_memory=False)

                self.train_simple_model(args, encoder, clean_data, args.step1_epochs, steps+1, self.tensor_writer)
